...
const OrderList = () => {
    ...
    const UpdateDelivery=(orderid,delivery_status) =>{
        ...
        Axios.put(`http://localhost:5000/api/artworks/updateDelivery/${orderid}`,{
        ...
        const getArtist = async () => {
            try {
                const res = await Axios.get(
                    `http://localhost:5000/api/artworks/allorders`,
                    {
                        headers: {
                            Authorization: "Bearer " + authCtx.token,
                        },
            ...
            return (
                <tbody>
                    <tr>
                        ...
                        <td className="admintd">
                        <button className="dbtn" onClick={()=>UpdateDelivery(item.order_id,item.delivery_status)}>{item.delivery_status ? "Delivered" : "Not Delivered"}</button>
                        </td>
